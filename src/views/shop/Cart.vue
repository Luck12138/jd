...
const useCartEffect = (shopId) => {
  ...
  return { total, price, productList, changeItemInfo }
}
export default {
  name: 'Cart',
  setup () {
    ...
    const { total, price, productList, changeItemInfo } = useCartEffect(shopId)
    return { total, price, productList, shopId, changeItemInfo }
  }
}
</script>
